...
public class Point {
    ...
    public Point rotatePoint(Point center, double angle) {
        ...
        double originX = this.x - center.x;
        double originY = this.y - center.y;
        double newX = center.x + (cosValue * originX) - (sinValue * originY);
        double newY = center.y + (sinValue * originX) + (cosValue * originY);
